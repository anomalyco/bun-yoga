...
//=============================================================================
// ENUMS VALUES (for easier FFI access)
//=============================================================================

// YGAlign enum values
pub export fn ygAlignAuto() c_int {
    return c.YGAlignAuto;
}
pub export fn ygAlignFlexStart() c_int {
    return c.YGAlignFlexStart;
}
pub export fn ygAlignCenter() c_int {
    return c.YGAlignCenter;
}
pub export fn ygAlignFlexEnd() c_int {
    return c.YGAlignFlexEnd;
}
pub export fn ygAlignStretch() c_int {
    return c.YGAlignStretch;
}
pub export fn ygAlignBaseline() c_int {
    return c.YGAlignBaseline;
}
pub export fn ygAlignSpaceBetween() c_int {
    return c.YGAlignSpaceBetween;
}
pub export fn ygAlignSpaceAround() c_int {
    return c.YGAlignSpaceAround;
}
pub export fn ygAlignSpaceEvenly() c_int {
    return c.YGAlignSpaceEvenly;
}

// YGDirection enum values
pub export fn ygDirectionInherit() c_int {
    return c.YGDirectionInherit;
}
pub export fn ygDirectionLTR() c_int {
    return c.YGDirectionLTR;
}
pub export fn ygDirectionRTL() c_int {
    return c.YGDirectionRTL;
}

// YGDisplay enum values
pub export fn ygDisplayFlex() c_int {
    return c.YGDisplayFlex;
}
pub export fn ygDisplayNone() c_int {
    return c.YGDisplayNone;
}
pub export fn ygDisplayContents() c_int {
    return c.YGDisplayContents;
}

// YGEdge enum values
pub export fn ygEdgeLeft() c_int {
    return c.YGEdgeLeft;
}
pub export fn ygEdgeTop() c_int {
    return c.YGEdgeTop;
}
pub export fn ygEdgeRight() c_int {
    return c.YGEdgeRight;
}
pub export fn ygEdgeBottom() c_int {
    return c.YGEdgeBottom;
}
pub export fn ygEdgeStart() c_int {
    return c.YGEdgeStart;
}
pub export fn ygEdgeEnd() c_int {
    return c.YGEdgeEnd;
}
pub export fn ygEdgeHorizontal() c_int {
    return c.YGEdgeHorizontal;
}
pub export fn ygEdgeVertical() c_int {
    return c.YGEdgeVertical;
}
pub export fn ygEdgeAll() c_int {
    return c.YGEdgeAll;
}

// YGFlexDirection enum values
pub export fn ygFlexDirectionColumn() c_int {
    return c.YGFlexDirectionColumn;
}
pub export fn ygFlexDirectionColumnReverse() c_int {
    return c.YGFlexDirectionColumnReverse;
}
pub export fn ygFlexDirectionRow() c_int {
    return c.YGFlexDirectionRow;
}
pub export fn ygFlexDirectionRowReverse() c_int {
    return c.YGFlexDirectionRowReverse;
}

// YGGutter enum values
pub export fn ygGutterColumn() c_int {
    return c.YGGutterColumn;
}
pub export fn ygGutterRow() c_int {
    return c.YGGutterRow;
}
pub export fn ygGutterAll() c_int {
    return c.YGGutterAll;
}

// YGJustify enum values
pub export fn ygJustifyFlexStart() c_int {
    return c.YGJustifyFlexStart;
}
pub export fn ygJustifyCenter() c_int {
    return c.YGJustifyCenter;
}
pub export fn ygJustifyFlexEnd() c_int {
    return c.YGJustifyFlexEnd;
}
pub export fn ygJustifySpaceBetween() c_int {
    return c.YGJustifySpaceBetween;
}
pub export fn ygJustifySpaceAround() c_int {
    return c.YGJustifySpaceAround;
}
pub export fn ygJustifySpaceEvenly() c_int {
    return c.YGJustifySpaceEvenly;
}

// YGMeasureMode enum values
pub export fn ygMeasureModeUndefined() c_int {
    return c.YGMeasureModeUndefined;
}
pub export fn ygMeasureModeExactly() c_int {
    return c.YGMeasureModeExactly;
}
pub export fn ygMeasureModeAtMost() c_int {
    return c.YGMeasureModeAtMost;
}

// YGNodeType enum values
pub export fn ygNodeTypeDefault() c_int {
    return c.YGNodeTypeDefault;
}
pub export fn ygNodeTypeText() c_int {
    return c.YGNodeTypeText;
}

// YGOverflow enum values
pub export fn ygOverflowVisible() c_int {
    return c.YGOverflowVisible;
}
pub export fn ygOverflowHidden() c_int {
    return c.YGOverflowHidden;
}
pub export fn ygOverflowScroll() c_int {
    return c.YGOverflowScroll;
}

// YGPositionType enum values
pub export fn ygPositionTypeStatic() c_int {
    return c.YGPositionTypeStatic;
}
pub export fn ygPositionTypeRelative() c_int {
    return c.YGPositionTypeRelative;
}
pub export fn ygPositionTypeAbsolute() c_int {
    return c.YGPositionTypeAbsolute;
}

// YGUnit enum values
pub export fn ygUnitUndefined() c_int {
    return c.YGUnitUndefined;
}
pub export fn ygUnitPoint() c_int {
    return c.YGUnitPoint;
}
pub export fn ygUnitPercent() c_int {
    return c.YGUnitPercent;
}
pub export fn ygUnitAuto() c_int {
    return c.YGUnitAuto;
}
pub export fn ygUnitMaxContent() c_int {
    return c.YGUnitMaxContent;
}
pub export fn ygUnitFitContent() c_int {
    return c.YGUnitFitContent;
}
pub export fn ygUnitStretch() c_int {
    return c.YGUnitStretch;
}

// YGWrap enum values
pub export fn ygWrapNoWrap() c_int {
    return c.YGWrapNoWrap;
}
pub export fn ygWrapWrap() c_int {
    return c.YGWrapWrap;
}
pub export fn ygWrapWrapReverse() c_int {
    return c.YGWrapWrapReverse;
}
